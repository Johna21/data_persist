...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 3936329566141976421),
      name: 'Customer',
      lastPropertyId: const IdUid(2, 8245049639977430650),
      flags: 2,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 6081599389791522923),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 8245049639977430650),
            name: 'name',
            type: 9,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(2, 6917732068795725051),
      name: 'ShopOrder',
      lastPropertyId: const IdUid(3, 4292118276014725405),
      flags: 2,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 4925708117185445686),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 6804637577415120234),
            name: 'price',
            type: 6,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 4292118276014725405),
            name: 'customerId',
            type: 11,
            flags: 520,
            indexId: const IdUid(1, 8670766382756603187),
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(2, 6917732068795725051),
      lastIndexId: const IdUid(1, 8670766382756603187),
